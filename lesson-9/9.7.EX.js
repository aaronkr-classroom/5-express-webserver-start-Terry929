...
app.get("/courses/:courseID",homeController.senCoursedReqParam); // @TODO: "/courses/:courseID"로의 GET 요청 처리 (추가)

/**
 * 다른 라우트 수정
 */
app.get("/",homeController.getHome); // @TODO: homeController에서 getHome을 가져와 사용한다
app.get("/conatact",homeController.getContact); // @TODO: homeController에서 getContact을 가져와 사용한다
